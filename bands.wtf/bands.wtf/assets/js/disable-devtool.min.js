! function(e, t) {
    ...
    function ne(e) {
        ...
        "function" == typeof w.ondevtoolclose && !0 === w.clearIntervalWhenDevOpenTrigger && (w.clearIntervalWhenDevOpenTrigger = !1, console.warn("ã€DISABLE-DEVTOOLã€‘clearIntervalWhenDevOpenTrigger åœ¨ä½¿ç”¨ ondevtoolclose æ—¶æ— æ•ˆ"))
    }
    ...
    var j, _ = function() {
            ...
            return c(n, [{
                ...
                value: function() {
                    var e;
                    console.warn("You ar not allow to use DEVTOOL! ã€type = ".concat(this.type, "ã€‘")), w.clearIntervalWhenDevOpenTrigger && y(), window.clearTimeout($), w.ondevtoolopen(this.type, ee), e = this.type, t[e] = !0
                }
            }, {
                key: "init",
                value: function() {}
    ...
    var ye, R, z, A;
    return L.md5 = ce, L.version = "0.3.1", L.DetectorType = j, L.isDevToolOpened = W, "undefined" != typeof document && (ye = document.querySelector("[disable-devtool-auto]")) && (R = ["disable-menu", "disable-select", "disable-copy", "disable-cut", "disable-paste", "clear-log"], z = ["interval"], A = {}, ["md5", "url", "tk-name", "detectors"].concat(R, z).forEach(function(e) {
